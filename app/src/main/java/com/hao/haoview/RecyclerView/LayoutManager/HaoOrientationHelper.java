...
public abstract class HaoOrientationHelper {
    ...
    private HaoOrientationHelper(RecyclerView.LayoutManager layoutManager) {
     ...
     */
    public static HaoOrientationHelper createOrientationHelper(
     ...
     * @return A new OrientationHelper
     */
    public static HaoOrientationHelper createHorizontalHelper(
            RecyclerView.LayoutManager layoutManager) {
        return new HaoOrientationHelper(layoutManager) {
            @Override
     ...
     * @return A new OrientationHelper
     */
    public static HaoOrientationHelper createVerticalHelper(RecyclerView.LayoutManager layoutManager) {
        return new HaoOrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
