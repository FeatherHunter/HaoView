...
public abstract class ViewPagerLayoutManager extends LinearLayoutManager {
    ...
    public static final int HORIZONTAL = HaoOrientationHelper.HORIZONTAL;

    public static final int VERTICAL = HaoOrientationHelper.VERTICAL;
     ...
     */
    protected HaoOrientationHelper mHaoOrientationHelper;
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (mDistanceToBottom == INVALID_SIZE) {
            ...
            mSpaceInOther = mHaoOrientationHelper.getTotalSpaceInOther() - mDecoratedMeasurementInOther - mDistanceToBottom;
        }
    ...
    void ensureLayoutState() {
        if (mHaoOrientationHelper == null) {
            mHaoOrientationHelper = HaoOrientationHelper.createOrientationHelper(this, mOrientation);
        }
    }
...
//            Log.i("feather", "i="+i);
    ...
    protected float maxRemoveOffset() {
        return mHaoOrientationHelper.getTotalSpace() - mSpaceMain;
    }
    ...
    protected float minRemoveOffset() {
        return -mDecoratedMeasurement - mHaoOrientationHelper.getStartAfterPadding() - mSpaceMain;
    }
    ...
    public int getDistanceToBottom() {
        return mDistanceToBottom == INVALID_SIZE ?
                (mHaoOrientationHelper.getTotalSpaceInOther() - mDecoratedMeasurementInOther) / 2 : mDistanceToBottom;
    }
